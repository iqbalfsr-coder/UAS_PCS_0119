    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        btn_fav.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v){
                ...
                Toast.makeText(getApplicationContext(),"Ditambahkan Difavorit, Pertandingan "+match.getStrHomeTeam(),Toast.LENGTH_SHORT).show();
            }
        });
        ...
        btnHapus.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(getApplicationContext(),"Menghapus Dari Favorite, Pertandingan "+match.getStrHomeTeam(),Toast.LENGTH_SHORT).show();
